  ...
  return (
    <div className="w-full max-w-lg space-y-6 rounded-xl border border-slate-200 bg-white p-8 shadow-sm dark:border-slate-800 dark:bg-slate-900">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <label htmlFor="businessSlug" className="mb-1.5 block text-sm font-medium text-slate-700 dark:text-slate-300">
            URL del lavadero
          </label>
          ...
          {slugAvailable === false && (
            <p className="mt-1 text-sm text-rose-600 dark:text-rose-400">Este slug no esta disponible</p>
          )}
          {errors.businessSlug && !slugAvailable && (
            <p className="mt-1 text-sm text-rose-600 dark:text-rose-400">{errors.businessSlug}</p>
          )}
        </div>
